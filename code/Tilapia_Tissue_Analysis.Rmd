...
```{r}
panel_volcano_plot_H4 <- plot_grid(Volcano_Plot_Gills_Kidney_H4, Volcano_Plot_Gills_Testes_H4, Volcano_Plot_Kidney_Testes_H4, ncol = 1, labels = c('B', 'C', 'D'), label_size = 12)
