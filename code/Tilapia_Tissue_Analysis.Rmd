...
```{r}
panel_volcano_plot_H2A <- plot_grid(Volcano_Plot_Gills_Kidney, Volcano_Plot_Gills_Testes, Volcano_Plot_Kidney_Testes, ncol=1, nrow = 3)
...
```{r}
panel_volcano_plot_H3 <- plot_grid(Volcano_Plot_Gills_Kidney, Volcano_Plot_Gills_Testes, Volcano_Plot_Kidney_Testes, ncol=1)
...
Total_Napho_hPTMs <- num_napho_only + num_ambic_and_napho + num_napho_and_trypsin + num_ambic_napho_trypsin # 284 biologically relevant histone PTMs can be detected using the V8 napho digestion method

Total_Ambic_hPTMs <- num_ambic_only + num_ambic_and_napho + num_trypsin_and_ambic + num_ambic_napho_trypsin # 265 biologically relevant histone PTMs can be detected using the V8 ambic digestion method

Total_Trypsin_hPTMs <- num_trypsin_only + num_trypsin_and_ambic + num_napho_and_trypsin + num_ambic_napho_trypsin # 114 biologically relevant histone PTMs can be detected using the trypsin/propionylation digestion method
...
Tissue_Statistics_SEM_2 <- Tissue_Statistics_SEM %>% 
  filter(hPTM_Name == "XP_019209842.1 H1-like K44 4-hydroxynonenal" |
           ...
           hPTM_Name == "XP_003448939.1 H2A Y50 Phospho / Dehydrated" |
           ...
           hPTM_Name == "XP_003459572.1 H2A K118 Acetyl" |
           hPTM_Name == "XP_003438147.1 H2B.L4 K7 Oxidation" |
           ...
           hPTM_Name == "XP_005463512.2 H3 S86 Phospho / Dehydrated" |
           hPTM_Name == "XP_005463512.2 H3 R83 Methyl" |
           hPTM_Name == "XP_005463512.2 H3 R40 Dimethyl" |
           hPTM_Name == "XP_005463512.2 H3 K64 GlyGly" |
           hPTM_Name == "XP_005463512.2 H3 K64 Acetyl" |
           hPTM_Name == "XP_025766521.1 H4-like K61 Acetyl" |
           hPTM_Name == "XP_025766521.1 H4-like T84 Phospho / Dehydrated" |
           hPTM_Name == "XP_025766521.1 H4-like R80 Dioxidation" |
           hPTM_Name == "XP_025766521.1 H4-like R42 Dimethyl" |
           hPTM_Name == "XP_025766521.1 H4-like K61 Dioxidation" |
           hPTM_Name == "XP_025766521.1 H4-like T84 Phospho / Dehydrated"
         )
...
Top_hPTMs_H1 <- Tissue_Statistics_SEM_3 %>% 
  filter(hPTM_Name == "XP_003459589.1 H1-like K52 Dioxidation" |
           hPTM_Name == "XP_019209842.1 H1-like K44 4-hydroxynonenal")

rep_str = c("XP_003459589.1 H1-like K52 Dioxidation" = "H1-like K52 Dioxidation", 
...
Top_hPTMs_H2A <- Tissue_Statistics_SEM_3 %>% 
  filter(hPTM_Name == "XP_003448939.1 H2A Y50 Phospho / Dehydrated" |
           hPTM_Name == "XP_003448939.1 H2A P48 Dioxidation" |
           hPTM_Name == "XP_003451211.1 H2A K95 Lactyl / Carboxyethyl" |
           hPTM_Name == "XP_003448939.1 H2A R77 Deamidated" |
           hPTM_Name == "XP_003448939.1 H2A R42 Deamidated" |
...
rep_str = c("XP_003448939.1 H2A Y50 Phospho / Dehydrated" = "H2A Y50 Phosphoryl", 
            "XP_003448939.1 H2A P48 Dioxidation" = "H2A P48 Dioxidation",
            ...
            "XP_003459572.1 H2A K118 Acetyl" = "H2A K118 Acetyl"
            )
...
Top_hPTMs_H2B <- Tissue_Statistics_SEM_3 %>% 
  filter(hPTM_Name == "XP_003438147.1 H2B.L4 K7 Oxidation" |
           hPTM_Name == "XP_003451196.1 H2B 1/2 K106 Acetyl" |
           hPTM_Name == "XP_003451196.1 H2B 1/2 S76 GlyGly" |
           hPTM_Name == "XP_003438147.1 H2B.L4 T86 GlyGly" |
           hPTM_Name == "XP_003438147.1 H2B.L4 T86 GlyGly" |
...
rep_str = c("XP_003438147.1 H2B.L4 K7 Oxidation" = "H2B.L4 K7 Oxidation", 
...
rep_str = c("XP_005463512.2 H3 K23 Acetyl" = "H3 K23 Acetyl", 
            "XP_005463512.2 H3 S86 Phospho / Dehydrated" = "H3 S86 Phosphoryl",
            "XP_005463512.2 H3 R83 Methyl" = "H3 R83 Methyl",
            "XP_005463512.2 H3 R40 Dimethyl" = "H3 R40 Dimethyl",
            "XP_005463512.2 H3 K64 GlyGly" = "H3 K64 GlyGly",
...
rep_str = c("XP_025766521.1 H4-like K61 Acetyl" = "H4-like K61 Acetyl", 
            "XP_025766521.1 H4-like T84 Phospho / Dehydrated" = "H4-like T84 Phosphoryl",
            "XP_025766521.1 H4-like R80 Dioxidation" = "H4-like R80 Dioxidation",
            "XP_025766521.1 H4-like R42 Dimethyl" = "H4-like R42 Dimethyl",
            "XP_025766521.1 H4-like K61 Dioxidation" = "H4-like K61 Dioxidation"
            )
...
length(unique(Up_Reg$hPTM_Name)) # 29 increased
...
length(unique(Up_Reg$hPTM_Name)) # 26 increased
...
length(unique(Up_Reg$hPTM_Name)) # 16 increased

Down_Reg <- PTM %>% 
  filter(Tissues == "Kidney_Testes") %>% 
  filter(Log2FC < 0)

length(unique(Down_Reg$hPTM_Name)) # 25 decreased
...
length(unique(Down_Reg$hPTM_Name)) # 22 decreased
...
length(unique(Up_Reg$hPTM_Name)) # 23 increased
...
length(unique(Down_Reg$hPTM_Name)) # 20 decreased
...
length(unique(Down_Reg$hPTM_Name)) # 23 decreased
...
length(unique(Up_Reg$hPTM_Name)) # 17 increased

Down_Reg <- PTM %>% 
  filter(Tissues == "Gills_Testes") %>% 
  filter(Log2FC < 0)

length(unique(Down_Reg$hPTM_Name)) # 28 decreased
...
length(unique(Up_Reg$hPTM_Name)) # 27 increased
...
length(unique(Up_Reg$hPTM_Name)) # 31 increased
...
length(unique(Down_Reg$hPTM_Name)) # 32 decreased
...
length(unique(Up_Reg$hPTM_Name)) # 20 increased

Down_Reg <- PTM %>% 
  filter(Tissues == "Kidney_Testes") %>% 
  filter(Log2FC < 0)

length(unique(Down_Reg$hPTM_Name)) # 31 decreased
